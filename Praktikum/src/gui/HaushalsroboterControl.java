...
public class HaushalsroboterControl {
	...
	public HaushalsroboterControl(Stage primarystage) {
		...
		Haushalsroboterview haushalsroboterview = new Haushalsroboterview(this,haushaltsrobotermodel,primarystage);
	}
	 void nehmeHaushaltsroboterAuf(){
    	try{ 
    		haushaltsrobotermodel.setHaushaltsroboter(new Haushaltsroboter(haushaltroboterview.getTxtName().getText(),Float.parseFloat(haushaltroboterview.getTxtPreis().getText()), haushaltroboterview.getTxtModell().getText(), haushaltroboterview.getTxtSensortyp().getText(), haushaltroboterview.getTxtFarben().getText()));
